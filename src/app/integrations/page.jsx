...
const IntegrationsPage = () => {
  ...
  const bgColor = useColorModeValue(
    'linear-gradient(135deg, rgba(255,107,44,0.05) 0%, rgba(255,154,92,0.05) 100%)',
    'gray.900'
  )
  const textColor = useColorModeValue('neutral.800', 'whiteAlpha.900')

  return (
    <Box bgGradient={bgColor} minH="100vh" pt={32}>
      <Box
        position="relative"
        overflow="hidden"
        py={28}
          ...
          >
            <VStack spacing={8} textAlign="center">
              <Heading
                ...
                bgSize="200% auto"
              >
                Powerful Integrations for Your<br />
              ...
              <Text 
                ...
                color={textColor}
              >
                Connect KeyReach CRM with your favorite tools and platforms to streamline your operations and boost productivity.
              </Text>
            </VStack>
          </MotionBox>
        </Container>
              ...
              >
                ...
                >
                  ...
                  <Text fontSize="lg" maxW="2xl" color={textColor}>
                    Contact us to learn how KeyReach CRM integrations can streamline your operations and boost your success.
                  </Text>
